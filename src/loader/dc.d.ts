...
declare module 'dc' {
  ...
  export class Popup {
    setPosition(position: String | Array<Number> | JSON | Position): Popup
    setContent(content: String): Popup
    setWrapper(wrapper: unknown): Popup
    showAt(position: String | Array<Number> | JSON | Position, content: String): Popup
    hide(): Popup
  }
